...
stops_geo <- st_as_sf(stops,coords=c("stop_lon","stop_lat"),crs = 4326, na.fail = T, remove=F)

st_write(stops_geo,paste0("D:/pontos_aps/todos_",Sys.Date(),".gpkg"),append=FALSE)
st_write(stops_geo,paste0("D:/pontos_aps/todos_",Sys.Date(),".kml"),append=FALSE)
write_xlsx(stops,paste0("D:/pontos_aps/todos_",Sys.Date(),".xlsx"))
fwrite(stops,paste0("D:/pontos_aps/todos_",Sys.Date(),".csv"))
